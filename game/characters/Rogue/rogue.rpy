init -1:
    ...
    define Rogue_base_Action_desire = 8

    define Rogue_Action_desires = {
        "spank": [0.1, 0.5, 1.0, 1.0, 0.5],

        "makeout": [0.2, 0.2, 0.2, 0.1, 0.05],
        "choke": [0.05, 0.1, 0.1, 0.1, 0.05],

        "touch_thighs_over_clothes": [0.5, 0.3, 0.2, 0.0, 0.0],
        "touch_thighs_higher_over_clothes": [0.6, 0.4, 0.3, 0.1, 0.0],
        "touch_thighs": [0.6, 0.4, 0.4, 0.2, 0.0],
        ...
        "eat_pussy": [0.2, 0.5, 1.0, 1.0, 0.8],
        "grab_ass_over_clothes": [0.6, 0.4, 0.3, 0.1, 0.0],
        "grab_ass": [0.7, 0.6, 0.3, 0.2, 0.0],
        ...
        "deepthroat": [0.2, 0.5, 0.5, 0.2, 0.0],
    ...
    define Rogue_Action_desire_thresholds = {
        "spank": 10,
