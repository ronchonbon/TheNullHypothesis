...
layeredimage Rogue_hands_and_knees:
    ...
    elif Player.cock_Actions and Rogue in Player.cock_Actions[0].Actors and Rogue.check_traits("orgasming"):
    ...
    elif Player.orgasming in ["cum_in_mouth", "cum_down_throat"] and focused_Character == Rogue:
    ...
    if Player.orgasming in ["cumshot", "cum_in_mouth"] and focused_Character == Rogue:
        "Rogue_hands_and_knees_thumb_[Player.orgasming]_animation"
    elif Player.orgasming == "cum_down_throat" and focused_Character == Rogue:
        Null()
    ...
    if Player.orgasming in ["cum_in_mouth", "cum_down_throat"] and focused_Character == Rogue:
...
layeredimage Rogue_hands_and_knees_torso:
    if Player.orgasming in ["cumshot", "cum_down_throat"] and focused_Character == Rogue:
        "Rogue_hands_and_knees_left_arm_handjob_animation0"
    elif Player.orgasming == "cum_in_mouth" and focused_Character == Rogue:
...
layeredimage Rogue_hands_and_knees_breasts:
    if Rogue.check_traits("breasts_supported") and Rogue.right_hand_Actions and Rogue.right_hand_Actions[0].animation_type == "self_touch_pussy":
        "characters/Rogue/images/hands_and_knees/breasts_supported_finger.webp"
    elif Rogue.check_traits("breasts_supported") and Rogue.right_hand_Actions and Rogue.right_hand_Actions[0].animation_type == "fondle_balls":
...
layeredimage Rogue_hands_and_knees_head:
    if Player.orgasming == "cum_in_mouth" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/head_agape.webp"
    elif Player.orgasming == "cum_down_throat" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/head_deepthroat.webp"
    elif (Player.orgasming and focused_Character == Rogue) or not Rogue.mouth_Actions:
    ...
    if Player.orgasming == "cum_down_throat" and focused_Character == Rogue:
        Null()
    elif (Player.orgasming and focused_Character == Rogue) or not Rogue.mouth_Actions:
...
layeredimage Rogue_hands_and_knees_hair:
    if (Rogue.check_traits("wet") or Rogue.Clothes["hair"].string == "wet") and Player.orgasming == "cum_on_face" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/hair_wet.webp"
    elif (Rogue.check_traits("wet") or Rogue.Clothes["hair"].string == "wet") and Player.orgasming == "cum_down_throat" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/hair_wet_deepthroat.webp"
    elif (Rogue.check_traits("wet") or Rogue.Clothes["hair"].string == "wet") and Rogue.mouth_Actions and Rogue.mouth_Actions[0].animation_type == "deepthroat":
        "characters/Rogue/images/hands_and_knees/hair_wet_deepthroat.webp"
    elif Rogue.check_traits("wet") or Rogue.Clothes["hair"].string == "wet":
        "characters/Rogue/images/hands_and_knees/hair_wet.webp"
    elif Rogue.Clothes["hair"].string in ["messy", "ponytail"] and Player.orgasming == "cum_on_face" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/hair_asymmetric.webp"
    elif Rogue.Clothes["hair"].string in ["messy", "ponytail"] and Player.orgasming == "cum_down_throat" and focused_Character == Rogue:
        "characters/Rogue/images/hands_and_knees/hair_asymmetric_deepthroat.webp"
    elif Rogue.Clothes["hair"].string in ["messy", "ponytail"] and Rogue.mouth_Actions and Rogue.mouth_Actions[0].animation_type == "deepthroat":
        "characters/Rogue/images/hands_and_knees/hair_asymmetric_deepthroat.webp"
    elif Rogue.Clothes["hair"].string in ["messy", "ponytail"]:
        "characters/Rogue/images/hands_and_knees/hair_asymmetric.webp"
    elif Player.orgasming == "cum_on_face" and focused_Character == Rogue:
