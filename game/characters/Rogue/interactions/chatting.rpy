        ...
        if dice_roll == 1:
            ...
            menu:
                ...
                "Great, now that I'm with you.":
                    ...
                    call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_686
                "I'm okay.":
                    $ Rogue.change_face("neutral")
                "Really? Never mind. . .":
                    $ Rogue.change_face("worried1") 
                    ...
                    call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_687
            ...
            menu:
                ...
                "If I wanted your advice, I'd ask for it.":
                    if Rogue.quirk:
                        ...
                        call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_688
        else:
