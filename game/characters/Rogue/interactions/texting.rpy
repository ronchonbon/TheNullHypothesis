...
label Rogue_text_how_are_you:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_783
...
label Rogue_text_how_are_you_late_accept:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_784
...
label Rogue_text_how_are_you_relationship:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_785
...
label Rogue_text_how_are_you_love:
    ...
    if Rogue.text_history[-1][1] == temp[0]:
        ...
        call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_786
    elif Rogue.text_history[-1][1] == temp[2]:
        call receive_text(Rogue, "Sorry") from _call_receive_text_552

        call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_787
...
label Rogue_text_how_are_you_horny:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_788
...
label Rogue_text_how_are_you_nympho:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_789
...
label Rogue_text_good_morning:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_790
...
label Rogue_text_good_morning_relationship:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_791
...
label Rogue_text_good_morning_love:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_792
    elif dice_roll == 2:
        ...
        if Rogue.text_history[-1][1] == temp[0]:
            ...
            call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_793
        elif Rogue.text_history[-1][1] == temp[2]:
...
label Rogue_text_good_morning_horny:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_794
...
label Rogue_text_good_morning_nympho:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_795
...
label Rogue_text_goodnight:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_796
...
label Rogue_text_goodnight_relationship:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_797
...
label Rogue_text_goodnight_love:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_798
    elif dice_roll == 2:
        ...
        if Rogue.text_history[-1][1] == temp[0]:
            ...
            call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_799
        elif Rogue.text_history[-1][1] == temp[2]:
            ...
            call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_800
...
label Rogue_text_goodnight_horny:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_801
...
label Rogue_text_goodnight_nympho:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_802
...
label Rogue_text_ignored:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_803
