...
label Rogue_dismiss_accept:
    menu:
        ...
        "I think you should leave.":
            ...
            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_779
        "Leave, give us some privacy." if len(Present) > 1:
            $ Rogue.change_face("worried1")

            ch_Rogue "Okay. . . sorry."

            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_780
        "Back":
            return False
...
label Rogue_dismiss_reject:
    menu:
        ...
        "I think you should leave.":
            ...
            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_781
        "Leave, give us some privacy." if len(Present) > 1:
            $ Rogue.change_face("angry1")

            ch_Rogue "Maybe if you asked polite-like."

            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_782
        "Back":
            return False
