...
label Rogue_accepts_show_breasts_after_first_time:
    ...
    menu:
        ...
        "Any good? They're perfect.":
            ...
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_1088
...
label Rogue_accepts_show_pussy_after_first_time:
    ...
    menu:
        ...
        ". . . I love it.":
            ...
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_1089
        "I do, it's beautiful.":
            $ Rogue.change_face("worried1", mouth = "smirk", blush = 1)
        "It's. . . okay. . .":
            $ Rogue.change_face("worried1", eyes = "down", blush = 1) 
            
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_1090
