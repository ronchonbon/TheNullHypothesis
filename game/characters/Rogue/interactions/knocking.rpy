    ...
    if dice_roll == 1:
        ...
        menu:
            ...
            "Nah.":
                ...
                call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_773
    elif dice_roll == 2:
        ...
        menu:
            ...
            "I'm busy.":
                call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_774
...
label Rogue_knocks_relationship(arriving_Characters):
    ...
    menu:
        ...
        "Not in the mood, [Rogue.name].":
            ...
            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_775
    ...
    if Rogue.quirk:
        ...
        menu:
            ...
            "I'm busy.":
                ...
                call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_776
    else:
        $ temp = Rogue.Player_petname.capitalize()
        ...
        menu:
            ...
            "Kinda in the middle of something.":
                ...
                call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_777
...
label Rogue_knocks_heartbroken(arriving_Characters):
    ...
    menu:
        ...
        "Stay silent":
            ...
            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_778
