label Rogue_heart_anal_plug_shopping_accept:
...
label Rogue_heart_anal_plug_shopping_reject:
...
label Rogue_heart_anal_plug_gift_accept:
    $ Rogue.change_face("sexy")
...
label Rogue_heart_anal_plug_gift_reject:
    $ Rogue.change_face("appalled2")
...
label Rogue_heart_anal_plug_change(plug_size):
...
label Rogue_heart_anal_plug_change_reject:
...
label Rogue_heart_anal_plug_change_reject_worn_out:
