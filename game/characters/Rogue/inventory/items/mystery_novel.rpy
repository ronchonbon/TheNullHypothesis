label Rogue_mystery_novel_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 30) from _call_change_Girl_stat_1561
    call change_Girl_stat(Rogue, "trust", 15) from _call_change_Girl_stat_1562
...
label Rogue_mystery_novel_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 30) from _call_change_Girl_stat_1563
    call change_Girl_stat(Rogue, "trust", 15) from _call_change_Girl_stat_1564
