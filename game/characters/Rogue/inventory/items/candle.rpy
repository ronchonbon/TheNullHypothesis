label Rogue_candle_shopping_accept:
    if EventScheduler.Events["Rogue_gifts"].completed:
        ...
        call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1545
        call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1546
...
label Rogue_candle_gift_accept:
    if EventScheduler.Events["Rogue_gifts"].completed:
        ...
        call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1547
        call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1548
