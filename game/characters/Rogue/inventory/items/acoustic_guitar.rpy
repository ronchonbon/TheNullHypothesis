label Rogue_acoustic_guitar_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 50) from _call_change_Girl_stat_1529
    call change_Girl_stat(Rogue, "trust", 20) from _call_change_Girl_stat_1530
...
label Rogue_acoustic_guitar_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 50) from _call_change_Girl_stat_1531
    call change_Girl_stat(Rogue, "trust", 20) from _call_change_Girl_stat_1532
