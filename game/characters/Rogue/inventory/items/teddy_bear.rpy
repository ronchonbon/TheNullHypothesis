label Rogue_teddy_bear_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 40) from _call_change_Girl_stat_1579
    call change_Girl_stat(Rogue, "trust", 20) from _call_change_Girl_stat_1580
...
label Rogue_teddy_bear_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 40) from _call_change_Girl_stat_1581
    call change_Girl_stat(Rogue, "trust", 20) from _call_change_Girl_stat_1582
