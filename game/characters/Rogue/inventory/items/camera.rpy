label Rogue_camera_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_1541
    call change_Girl_stat(Rogue, "trust", 0) from _call_change_Girl_stat_1542
...
label Rogue_camera_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 0) from _call_change_Girl_stat_1543
    call change_Girl_stat(Rogue, "trust", 0) from _call_change_Girl_stat_1544
