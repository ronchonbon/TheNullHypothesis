label Rogue_horror_novel_shopping_accept:
    ...
    call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_1553
    call change_Companion_stat(Rogue, "trust", 0) from _call_change_Companion_stat_1554
...
label Rogue_horror_novel_gift_accept:
    ...
    call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_1555
    call change_Companion_stat(Rogue, "trust", 0) from _call_change_Companion_stat_1556
