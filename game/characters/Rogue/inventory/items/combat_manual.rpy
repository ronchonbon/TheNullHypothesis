label Rogue_combat_manual_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 20) from _call_change_Girl_stat_1549
    call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1550
...
label Rogue_combat_manual_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 20) from _call_change_Girl_stat_1551
    call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1552
