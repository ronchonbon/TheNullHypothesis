label Rogue_plant_shopping_accept:
    ...
    if "plant1" in Rogue.inventory.keys() or "plant2" in Rogue.inventory.keys() or "plant3" in Rogue.inventory.keys():
        ...
        call change_Girl_stat(Rogue, "love", 10) from _call_change_Girl_stat_1569
    else:
        ...
        call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1570
...
label Rogue_plant_gift_accept:
    ...
    if "plant1" in Rogue.inventory.keys() or "plant2" in Rogue.inventory.keys() or "plant3" in Rogue.inventory.keys():
        ...
        call change_Girl_stat(Rogue, "love", 10) from _call_change_Girl_stat_1571
    else:
        ch_Rogue "Are these for my room?"
        ...
        call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1572
