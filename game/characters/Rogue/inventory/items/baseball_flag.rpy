label Rogue_baseball_flag_shopping_accept:
    ...
    call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1533
    call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1534
...
label Rogue_baseball_flag_gift_accept:
    ...
    call change_Girl_stat(Rogue, "love", 25) from _call_change_Girl_stat_1535
    call change_Girl_stat(Rogue, "trust", 10) from _call_change_Girl_stat_1536
