init python:
    ...
    def all_Rogue_Clothes():
        Clothes = [
            ...
            Rogue_black_lowcut_top(),
            # Rogue_black_NIN_shirt(),
            Rogue_black_spiked_bracelets(),
            Rogue_black_sports_bra(),
            Rogue_black_strap_pumps(),
            Rogue_black_tanktop(),
            Rogue_brown_classic_jacket(),
            Rogue_brown_utility_belt(),
            # Rogue_dark_denim_shorts(),
