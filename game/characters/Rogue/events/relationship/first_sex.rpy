...
label Rogue_first_sex:
    ...
    call change_Girl_stat(Rogue, "desire", 5) from _call_change_Girl_stat_1146
    ...
    menu:
        ...
        "That really was amazing. I'm glad it lived up to your expectations.":
            call change_Girl_stat(Rogue, "love", 10) from _call_change_Girl_stat_1147
        "Yeah, that wasn't too bad. You'll get better the more we do it together.":
            $ Rogue.change_face("worried1", blush = 1)

            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_1148
