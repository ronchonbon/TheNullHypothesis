...
label Rogue_chapter_one_season_one_first_training_session:
    ...
    menu:
        ...
        "Of course, I wouldn't ask if I weren't serious.":
            call change_Character_stat(Rogue, "love", medium_stat) from _call_change_Character_stat_1617
            call change_Character_stat(Rogue, "trust", medium_stat) from _call_change_Character_stat_1618

            $ Rogue.change_face("worried1", mouth = "smirk")

            ch_Rogue "Ah know. . ."
        "It couldn't be any worse than training with [Laura.name], that's for sure.":
            call change_Character_stat(Rogue, "love", small_stat) from _call_change_Character_stat_1619
            call change_Character_stat(Rogue, "trust", small_stat) from _call_change_Character_stat_1620
