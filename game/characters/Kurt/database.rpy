label update_Kurt_database:
    ...
    $ Kurt.database["comments"] = [
        f"{Rogue.call_sign}: Oh come on! How come he gets the only good one?!",
        f"{Jean.call_sign}: Come on, Kurt, 'fess up, who did you pay to write this?",
        f"{Kurt.call_sign}: I would never! . . . especially not when I can bamf right into zee writers' offices and accidentally change a few lines of text for free >;)"]
