...
layeredimage Laura_hands_and_knees:
    ...
    elif Player.orgasming in ["cum_in_mouth", "cum_down_throat"] and focused_Character == Laura:
    ...
    if Player.orgasming in ["cumshot", "cum_in_mouth"] and focused_Character == Laura:
        "Laura_hands_and_knees_thumb_[Player.orgasming]_animation"
    elif Player.orgasming == "cum_down_throat" and focused_Character == Laura:
        Null()
    ...
    if Player.orgasming in ["cum_in_mouth", "cum_down_throat"] and focused_Character == Laura:
...
layeredimage Laura_hands_and_knees_torso:
    if Player.orgasming in ["cumshot", "cum_down_throat"] and focused_Character == Laura:
        "Laura_hands_and_knees_left_arm_handjob_animation0"
    elif Player.orgasming == "cum_in_mouth" and focused_Character == Laura:
...
layeredimage Laura_hands_and_knees_head:
    if Player.orgasming == "cum_in_mouth" and focused_Character == Laura:
        "characters/Laura/images/hands_and_knees/head_agape.webp"
    elif Player.orgasming == "cum_down_throat" and focused_Character == Laura:
        "characters/Laura/images/hands_and_knees/head_deepthroat.webp"
    elif (Player.orgasming and focused_Character == Laura) or not Laura.mouth_Actions:
    ...
    if Player.orgasming == "cum_down_throat" and focused_Character == Laura:
        Null()
    elif (Player.orgasming and focused_Character == Laura) or not Laura.mouth_Actions:
...
layeredimage Laura_hands_and_knees_hair:
    ...
    #     "characters/Laura/images/hands_and_knees/hair_wet.webp"
    if Laura.Clothes["hair"].string in ["bun", "tucked"] and Player.orgasming == "cum_on_face" and focused_Character == Laura:
        "characters/Laura/images/hands_and_knees/hair_shadow_straight.webp"
    elif Laura.Clothes["hair"].string in ["bun", "tucked"] and Player.orgasming == "cum_down_throat" and focused_Character == Laura:
        "characters/Laura/images/hands_and_knees/hair_shadow_straight_deepthroat.webp"
    elif Laura.Clothes["hair"].string in ["bun", "tucked"] and Laura.mouth_Actions and Laura.mouth_Actions[0].animation_type == "deepthroat":
        "characters/Laura/images/hands_and_knees/hair_shadow_straight_deepthroat.webp"
    elif Laura.Clothes["hair"].string in ["bun", "tucked"]:
        "characters/Laura/images/hands_and_knees/hair_shadow_straight.webp"
    elif Player.orgasming == "cum_on_face" and focused_Character == Laura:
    ...
    if Laura.Clothes["hair"].string in ["bun", "tucked"] and Player.orgasming == "cum_on_face" and focused_Character == Laura:
        ...
        "characters/Laura/images/hands_and_knees/hair_straight_deepthroat.webp"
    elif Laura.Clothes["hair"].string in ["bun", "tucked"] and Laura.mouth_Actions and Laura.mouth_Actions[0].animation_type == "deepthroat":
        "characters/Laura/images/hands_and_knees/hair_straight_deepthroat.webp"
    elif Laura.Clothes["hair"].string in ["bun", "tucked"]:
        "characters/Laura/images/hands_and_knees/hair_straight.webp"
