...
label Laura_chapter_one_season_two_first_training_session:
    ...
    menu:
        ...
        "Holy shit. . . that was exhilarating.":
            ...
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_447
        "Maybe a fucking warning next time ?!":
            $ Laura.change_face("appalled1") 
            
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_448
        "What if I didn't duck in time. . . ?":
            $ Laura.change_face("angry1") 
            
            call change_Girl_stat(Laura, "trust", 0) from _call_change_Girl_stat_449
