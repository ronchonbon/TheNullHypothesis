...
label Laura_chapter_one_season_two_second_training_session:
    ...
    menu:
        ...
        "I feel great, thanks.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_451 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_452
        "Uh. . . am I dreaming?":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_453
        "Like shit, because I know how much this is gonna suck.":
            $ Laura.change_face("furious") 
            
            ch_Laura "Suck it up." 
            
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_454
    ...
    menu:
        ...
        "I'm sorry, I really don't mean to stress you out.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_455
        "I hate being a burden to you too. I refuse to be one for much longer.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_456 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_457
        "How much anxiety do you think {i}I{/i} feel, having so many near-death experiences?!":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_458 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_459
