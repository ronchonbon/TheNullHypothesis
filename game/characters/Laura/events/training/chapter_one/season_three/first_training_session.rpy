...
label Laura_chapter_one_season_three_first_training_session:
    ...
    menu:
        ...
        "Absolutely not, it's terrifying.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_432 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_433
        "No, but I sure as hell want to try them out.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_434 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_435
        "Not yet, but I am kinda eager to figure them out.":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_436 
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_437
    ...
    menu:
        ...
        "Dangerous. . . to you in particular? I do appreciate how much you're trusting me.":
            ...
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_438
        "You think so? Sweet.":
            $ Laura.change_face("suspicious1")

            ch_Laura ". . ." 
            
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_439
    ...
    menu:
        ...
        "Are you sure about this?":
            ...
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_440
        "Brace yourself.":
            pass
        "I'm the one who should be focused on survival?":
            ...
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_441
