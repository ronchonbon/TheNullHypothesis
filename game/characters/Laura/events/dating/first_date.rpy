...
label Laura_first_date:
    ...
    if chosen_meal[Player] in ["filet mignon", "ribeye"]:
        ...
        menu:
            ...
            "I don't really eat steak. . .":
                ...
                call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_326
    ...
    if chosen_meal[Player] in ["filet_mignon", "ribeye"]:
        ...
        if chosen_meal[Player] == "ribeye":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_327
        else:
            $ Laura.change_face("neutral")
        ...
        if chosen_meal[Laura] == "ribeye":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_328
        else:
            ch_Laura "Good."
    ...
    menu:
        ...
        "Don't argue and pay" if Player.cash >= restaurant_bill[Player] + restaurant_bill[Laura]:
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_329
        ...
        "Explain why you should split the bill" if Player.cash >= math.ceil((restaurant_bill[Player] + restaurant_bill[Laura])/2):
            ...
            call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_330
        ...
        "Have her pay":
            ...
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_331
    ...
    menu:
        ...
        "If you're not ready, that's totally fine.":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_332 
            call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_333
        "That's usually the case, yeah.":
            $ Laura.change_face("confused1", mouth = "smirk", eyes = "squint", blush = 2) 
            
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_334
        ". . . Well?":
            $ Laura.change_face("angry1", eyes = "right", blush = 1)

            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_335
    ...
    call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_336
    ...
    if Laura.History.check("Player_told_to_ask_to_kiss"):
        ...
        menu:
            ...
            "Encourage this behavior (encourage_quirk)":
                ...
                call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_337 
                
                ch_Laura "Good." 
                ch_Laura "I. . . enjoyed that as well." 
                ch_Laura "Expect it to happen again." 
                
                call change_Girl_stat(Laura, "love", 10) from _call_change_Girl_stat_338
