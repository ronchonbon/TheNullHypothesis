...
label Laura_jealousy_went_on_date_anyways:
    ...
    call change_Character_stat(Laura, "trust", -large_stat) from _call_change_Character_stat_942
...
label Laura_jealousy_flirted_anyways:
    ...
    call change_Character_stat(Laura, "trust", -large_stat) from _call_change_Character_stat_1039
