...
label Laura_first_sex_part_one:
    ...
    menu:
        ...
        "I also think talking about it is a good idea. . .":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_934 
            call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_935
        "Wha. . . I. . . uh. . . yeah, talking is a good idea.":
            $ Laura.change_face("angry1", eyes = "squint", blush = 1) 

            ch_Laura "It is."
            
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_936
        "Oh god, don't tell me I have to explain this shit to you. . .":
            $ Laura.change_face("angry1", eyes = "squint", blush = 1) 

            ch_Laura "No, you do not."
            
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_937
...
label Laura_first_sex_part_two:
    ...
    menu:
        ...
        "That was amazing. I'm glad you enjoyed it as well.":
            ...
            call change_Girl_stat(Laura, "love", 10) from _call_change_Girl_stat_938
        "That was okay. You'll get better the more we do it together.":
            $ Laura.change_face("confused1", blush = 1) 
            
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_939
