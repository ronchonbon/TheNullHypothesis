    ...
    while chatting:
        menu:
            ...
            "Why me?" if not asked_why_me:
                ...
                call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_360
            ...
            "So, you don't really know what it means to be a friend?" if not asked_meaning:
                ...
                call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_361
...
label Laura_first_friend_part_one_1A:
    ...
    menu:
        ...
        "I'm sorry, that must've been tough. . .":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_362

            ch_Laura "Why are you sorry?"
        "Makes sense, why you're. . .":
            $ Laura.change_face("confused1")

            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_363
...
label Laura_first_friend_part_one_1B:
    ...
    menu:
        ...
        "I can try to help you learn.":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_364
            call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_365

            ch_Laura "So you are my friend now?"
        "Are you even capable of that?":
            $ Laura.change_face("angry1")

            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_366
            call change_Girl_stat(Laura, "trust", -5) from _call_change_Girl_stat_367
...
label Laura_first_friend_part_two:
    ...
    call change_Girl_stat(Laura, "desire", 5) from _call_change_Girl_stat_368
    ...
    while chatting:
        menu:
            ...
            "Recommend she talk to [Rogue.name] about it":
                ...
                call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_369
    ...
    call change_Girl_stat(Rogue, "love", 5) from _call_change_Girl_stat_370
...
label Laura_first_friend_part_two_1A:
    ...
    call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_371
    call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_372
    call change_Girl_stat(Laura, "desire", 5) from _call_change_Girl_stat_373
...
label Laura_first_friend_part_three:
    ...
    if approval_check(Rogue, "love", threshold = Rogue_thresholds["dating"][0]):
        ...
        call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_374
        call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_375
...
label Laura_first_friend_part_three_1A:
    menu:
        ...
        ". . . {i}{size=-5}yet{/size}{/i}.":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_376
        ". . .":
            pass
...
label Laura_first_friend_part_three_1B:
    ...
    menu:
        ...
        "I appreciate it. . . but no, that's not how friends normally do it. (discourage_quirk)":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_377
        ...
        "Uhh. . . no. That's kind of weird. (discourage_quirk)":
            ...
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_378
        ...
        "Not normally in that way. . . but I like it. (encourage_quirk)":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_379
            call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_380
