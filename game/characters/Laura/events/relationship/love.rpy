init python:
    ...
    def Laura_I_love_you():
        ...
        conditions = [
            ...
            "day - EventScheduler.Events['Laura_penultimate_quirk'].completed >= 3",
...
label Laura_I_love_you:
    ...
    if Rogue.text_history[-1][1] == temp[0]:
        ...
        call change_Girl_stat(Rogue, "love", 5) from _call_change_Girl_stat_1040
    ...
    menu:
        ...
        "No, thank you for letting me know. I know what you mean, and this is important, to all of us.":
            ...
            call change_Girl_stat(Rogue, "love", 5) from _call_change_Girl_stat_1041 
            call change_Girl_stat(Rogue, "trust", 5) from _call_change_Girl_stat_1042
        "I. . . just never expected. . . No, thank you for letting me know, this is important.":
            ...
            call change_Girl_stat(Rogue, "love", 10) from _call_change_Girl_stat_1043
        "No, it really isn't your place to be giving me advice about my relationship, but regardless, thanks for letting me know.":
            ...
            call change_Girl_stat(Rogue, "love", -5) from _call_change_Girl_stat_1044
    ...
    menu:
        ...
        "I know you're struggling with parts of yourself, but I want you to feel like you can let me share some of that burden.":
            call change_Girl_stat(Laura, "love", 10) from _call_change_Girl_stat_1045 
            call change_Girl_stat(Laura, "trust", 10) from _call_change_Girl_stat_1046
        "[Laura.name], I know you've been talking to [Rogue.name] about what you're struggling with, but I'm your boyfriend. You can come to me for support too. . .":
            call change_Girl_stat(Laura, "love", 20) from _call_change_Girl_stat_1047
        "Seriously, [Laura.name], I am your boyfriend. I know you've been leaning on [Rogue.name], but you need to start coming to me for support.":
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_1048 
            call change_Girl_stat(Laura, "trust", 10) from _call_change_Girl_stat_1049
    ...
    menu:
        ...
        "[Laura.name], if it makes it easier. . . I love you.":
            call change_Girl_stat(Laura, "love", 15) from _call_change_Girl_stat_1050
    ...
    if Laura.quirk:
        ...
        menu:
            ...
            "I was hoping you'd say that. . . use me to your heart's content.":
                call change_Girl_stat(Laura, "love", 10) from _call_change_Girl_stat_1051
            "I'm sorry I frustrate you so much. . . don't hesitate to make me pay for it.":
                call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_1052 
                call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_1053
            "It's not my fault you're so horny all the time, but fine, you know I'll be available.":
                call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_1054
        ...
        menu:
            ...
            "I'm also looking forward to it, and I will do my best to alleviate your frustrations.":
                call change_Girl_stat(Laura, "love", 10) from _call_change_Girl_stat_1055
            "I'm sorry I frustrate you so much. . . but don't worry, I'll help alleviate your frustrations the best I can.":
                call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_1056 
                call change_Girl_stat(Laura, "trust", 5) from _call_change_Girl_stat_1057
            "It's not my fault you're so horny all the time, but yeah, we'll figure it out.":
                call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_1058
...
label Laura_I_love_you_1B:
    ...
    if Laura.text_history[-1][1] == temp[0]:
        call change_Girl_stat(Laura, "trust", 15) from _call_change_Girl_stat_1059
    elif Laura.text_history[-1][1] == temp[2]:
        call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_1060
