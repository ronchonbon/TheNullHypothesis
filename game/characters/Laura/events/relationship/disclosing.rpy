...
label Laura_disclosing_wants_to_date_others:
    ...
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_642
...
label Laura_disclosing_wants_to_date_Rogue:
    ...
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_643
...
label Laura_disclosing_wants_to_date_Jean:
    ...
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_931
