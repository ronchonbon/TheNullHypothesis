...
label Laura_texting_training_response:
    ...
    if Laura.text_history[-1][1] == temp[0]:
        ...
        if time_index > 2:
            ...
            call change_Girl_stat(Laura, "love", -2) from _call_change_Girl_stat_1605
        else:
        ...
        call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_352
...
label Laura_texting_date_response:
    ...
    if Laura.text_history[-1][1] == temp[0]:
        ...
        if time_index > 2:
            ...
            call change_Girl_stat(Laura, "love", -2) from _call_change_Girl_stat_1600
        else:
            call receive_text(Laura, "Good") from _call_receive_text_289

            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_353
        ...
        call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_354
