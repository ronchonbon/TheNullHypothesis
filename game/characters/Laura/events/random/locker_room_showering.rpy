init python:
    ...
    def Laura_locker_room_showering():
        ...
        conditions = [
            "day - EventScheduler.Events['Laura_locker_room_showering'].completed > 0",
...
label Laura_locker_room_showering:
    ...
    if Laura in Partners:
        ...
        call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_345
        ...
        call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_346
