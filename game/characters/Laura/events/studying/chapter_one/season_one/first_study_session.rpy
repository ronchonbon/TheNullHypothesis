...
label Laura_chapter_one_season_one_first_study_session:
    ...
    menu:
        ...
        "I know you think class is a waste of time, but it's important in its own way.":
            call change_Girl_stat(Laura, "love", medium_stat) from _call_change_Girl_stat_912
            call change_Girl_stat(Laura, "trust", small_stat) from _call_change_Girl_stat_913
        ...
        "C'mon, [Laura.name], do you really think class is such a waste of time?":
            call change_Girl_stat(Laura, "love", medium_stat) from _call_change_Girl_stat_914
        ...
        "Seriously, [Laura.name], are you trying to fail?":
            call change_Girl_stat(Laura, "love", -medium_stat) from _call_change_Girl_stat_916
    ...
    menu:
        extend ""
        "I'll try my best.":
            call change_Girl_stat(Laura, "love", medium_stat) from _call_change_Girl_stat_917
            call change_Girl_stat(Laura, "trust", small_stat) from _call_change_Girl_stat_993
        ...
        "I guess I can. . .":            
            call change_Girl_stat(Laura, "love", small_stat) from _call_change_Girl_stat_994
            call change_Girl_stat(Laura, "trust", small_stat) from _call_change_Girl_stat_1016
        ...
        "Can't you just pay more attention during lecture?":
            call change_Girl_stat(Laura, "trust", -small_stat) from _call_change_Girl_stat_1017
