label Laura_heart_anal_plug_shopping_accept:
...
label Laura_heart_anal_plug_gift_accept:
    $ Laura.change_face("confused1")
...
label Laura_heart_anal_plug_change(plug_size):
...
label Laura_heart_anal_plug_change_reject:
...
label Laura_heart_anal_plug_change_reject_worn_out:
    $ Laura.change_face("angry1")
