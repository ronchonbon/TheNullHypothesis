label Laura_plant_shopping_accept:
    ...
    if "plant1" in Laura.inventory.keys() or "plant2" in Laura.inventory.keys() or "plant3" in Laura.inventory.keys():
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1473
    else:
        ch_Laura "A plant?"
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1474
...
label Laura_plant_gift_accept:
    ...
    if "plant1" in Laura.inventory.keys() or "plant2" in Laura.inventory.keys() or "plant3" in Laura.inventory.keys():
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1475
    else:
        ch_Laura "A plant?"
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1476
