label Laura_steamy_romance_novel_shopping_accept:
    if EventScheduler.Events["Laura_boyfriend"].completed:
        ...
        call change_Girl_stat(Laura, "love", 25) from _call_change_Girl_stat_1481
        call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_1482
...
label Laura_steamy_romance_novel_gift_accept:
    if EventScheduler.Events["Laura_boyfriend"].completed:
        ...
        call change_Girl_stat(Laura, "love", 25) from _call_change_Girl_stat_1483
        call change_Girl_stat(Laura, "desire", 10) from _call_change_Girl_stat_1484
