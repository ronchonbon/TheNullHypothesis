label Laura_record_player_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_1477
    call change_Girl_stat(Laura, "trust", 0) from _call_change_Girl_stat_1478
...
label Laura_record_player_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_1479
    call change_Girl_stat(Laura, "trust", 0) from _call_change_Girl_stat_1480
