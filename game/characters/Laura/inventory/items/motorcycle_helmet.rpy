label Laura_motorcycle_helmet_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 40) from _call_change_Girl_stat_1465
    call change_Girl_stat(Laura, "trust", 25) from _call_change_Girl_stat_1466
...
label Laura_motorcycle_helmet_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 40) from _call_change_Girl_stat_1467
    call change_Girl_stat(Laura, "trust", 25) from _call_change_Girl_stat_1468
