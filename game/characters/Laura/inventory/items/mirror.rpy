label Laura_mirror_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 15) from _call_change_Girl_stat_1461
    call change_Girl_stat(Laura, "trust", 30) from _call_change_Girl_stat_1462
...
label Laura_mirror_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 15) from _call_change_Girl_stat_1463
    call change_Girl_stat(Laura, "trust", 30) from _call_change_Girl_stat_1464
