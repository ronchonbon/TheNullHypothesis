label Laura_box_of_chocolates_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 20) from _call_change_Girl_stat_1443
    call change_Girl_stat(Laura, "trust", 10) from _call_change_Girl_stat_1444
...
label Laura_box_of_chocolates_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 20) from _call_change_Girl_stat_1445
    call change_Girl_stat(Laura, "trust", 10) from _call_change_Girl_stat_1446
