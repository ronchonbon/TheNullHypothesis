label Laura_MMA_gloves_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 40) from _call_change_Girl_stat_1435
    call change_Girl_stat(Laura, "trust", 15) from _call_change_Girl_stat_1436
...
label Laura_MMA_gloves_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 40) from _call_change_Girl_stat_1437
    call change_Girl_stat(Laura, "trust", 15) from _call_change_Girl_stat_1438
