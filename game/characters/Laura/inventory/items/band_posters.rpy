label Laura_band_posters_shopping_accept:
    ...
    call change_Girl_stat(Laura, "love", 30) from _call_change_Girl_stat_1439
    call change_Girl_stat(Laura, "trust", 15) from _call_change_Girl_stat_1440
...
label Laura_band_posters_gift_accept:
    ...
    call change_Girl_stat(Laura, "love", 30) from _call_change_Girl_stat_1441
    call change_Girl_stat(Laura, "trust", 15) from _call_change_Girl_stat_1442
