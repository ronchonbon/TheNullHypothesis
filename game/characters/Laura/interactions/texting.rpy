...
label Laura_text_how_are_you:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_503
...
label Laura_text_how_are_you_late_accept:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_504
...
label Laura_text_how_are_you_relationship:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_505
...
label Laura_text_how_are_you_love:
    ...
    if Laura.text_history[-1][1] == temp[0]:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_506
    elif Laura.text_history[-1][1] == temp[2]:
        call receive_text(Laura, "Asshole") from _call_receive_text_344

        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_507
...
label Laura_text_how_are_you_horny:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_508
...
label Laura_text_how_are_you_nympho:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_509
...
label Laura_text_good_morning:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_510
...
label Laura_text_good_morning_relationship:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_511
...
label Laura_text_good_morning_love:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_512
    elif dice_roll == 2:
        ...
        if Laura.text_history[-1][1] == temp[0]:
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_513
        elif Laura.text_history[-1][1] == temp[2]:
...
label Laura_text_good_morning_horny:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_514
...
label Laura_text_good_morning_nympho:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_515
...
label Laura_text_goodnight:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_516
...
label Laura_text_goodnight_relationship:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_517
...
label Laura_text_goodnight_love:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_518
    elif dice_roll == 2:
        ...
        if Laura.text_history[-1][1] == temp[0]:
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_519
        elif Laura.text_history[-1][1] == temp[2]:
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_520
...
label Laura_text_goodnight_horny:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_521
...
label Laura_text_goodnight_nympho:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_522
...
label Laura_text_ignored:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_523
