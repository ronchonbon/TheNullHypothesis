...
label Laura_accepts_show_breasts_after_first_time:
    ...
    menu:
        ...
        "Very. . . happy.":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_1063
        "They're pretty nice.":
            $ Laura.change_face("sexy", eyes = "down", blush = 1)
        "They're. . . fine.":
...
label Laura_accepts_show_pussy_after_first_time:
    ...
    menu:
        ...
        "Can't help it. . . your. . . is perfect.":
            ...
            call change_Girl_stat(Laura, "love", 5) from _call_change_Girl_stat_1064
        ...
        "Yeah. . . it's not bad. . .":
            ...
            call change_Girl_stat(Laura, "love", -5) from _call_change_Girl_stat_1065 
