...
label Laura_summon_reject_asked_once:
    ...
    call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_497
...
label Laura_dismiss_accept:
    menu:
        ...
        "I think you should leave.":
            ...
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_498
        "Leave, give us some privacy." if len(Present) > 1:
            $ Laura.change_face("appalled1")

            ch_Laura ". . ."

            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_499
        "Back":
            return False
...
label Laura_dismiss_reject:
    menu:
        ...
        "I think you should leave.":
            ...
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_500
        "Leave, give us some privacy." if len(Present) > 1:
            $ Laura.change_face("appalled2")

            ch_Laura "Don't try and order me around."

            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_501
        "Back":
            return False
...
label Laura_dismiss_reject_asked_once:
    ...
    call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_502
