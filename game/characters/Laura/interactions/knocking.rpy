    ...
    if dice_roll == 1:
        ...
        menu:
            ...
            "I'd rather not. . .":
                ...
                call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_491
    elif dice_roll == 2:
        ...
        menu:
            ...
            "No, I'm busy.":
                call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_492
...
label Laura_knocks_relationship(arriving_Characters):
    ...
    menu:
        ...
        "Not in the mood, [Laura.name].":
            ...
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_493
    ...
    if Laura.quirk:
        ...
        menu:
            ...
            "I'm busy.":
                ...
                call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_494
    else:
        ...
        menu:
            ...
            "Kinda in the middle of something.":
                ...
                call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_495
...
label Laura_knocks_heartbroken(arriving_Characters):
    ...
    menu:
        ...
        "Stay silent":
            ...
            call change_Girl_stat(Laura, "love", 0) from _call_change_Girl_stat_496
