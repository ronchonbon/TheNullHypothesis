...
label Laura_flirt_aa:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_469
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_470
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_471
...
label Laura_flirt_ab:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_472
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_473
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_474
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_475
...
label Laura_flirt_ac:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_476
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_477
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_478
    elif dice_roll == 4:
        $ Laura.change_face("pleased1", blush = 1) 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_479
...
label Laura_flirt_ad:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_480
    elif dice_roll == 2:
        $ Laura.change_face("sly", blush = 1) 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_481
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_482
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_483
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_484
    elif dice_roll == 4:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_485
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_486
...
label Laura_flirt_ae:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1329
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1330
    elif dice_roll == 2:
        $ Laura.change_face("sly", blush = 1) 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1331
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1332
    elif dice_roll == 3:
        $ Laura.change_face("appalled1")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1333
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1334
    elif dice_roll == 4:
        $ Laura.change_face("appalled1") 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1335
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1336
...
label Laura_flirt_af:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1337 
    elif dice_roll == 2:
        $ Laura.change_face("confused1")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1338
...
label Laura_flirt_ag:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1339
    elif dice_roll == 2:
        $ Laura.change_face("surprised2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1340
    elif dice_roll == 3:
        $ Laura.change_face("appalled1") 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1341
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1342
    elif dice_roll == 4:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1343
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1344
...
label Laura_flirt_ah:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1345
    elif dice_roll == 2:
        $ Laura.change_face("surprised2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1346
...
label Laura_flirt_ai:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1347
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1348
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1349
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1350
    elif dice_roll == 3:
        $ Laura.change_face("pleased2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1351
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1352
    elif dice_roll == 4:
        $ Laura.change_face("pleased2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1353
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1354
...
label Laura_flirt_aj:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1355 
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1356 
    elif dice_roll == 3:
        $ Laura.change_face("surprised2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1357
...
label Laura_flirt_ak:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_487
    elif dice_roll == 2:
        $ Laura.change_face("pleased1", blush = 1) 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_488
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_489
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_490
...
label Laura_flirt_al:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1358 
...
label Laura_flirt_am:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1359
    elif dice_roll == 2:
        $ Laura.change_face("surprised2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1360
    elif dice_roll == 3:
        $ Laura.change_face("confused1", blush = 1)
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1361
...
label Laura_flirt_an:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1362
    elif dice_roll == 2:
        $ Laura.change_face("pleased1")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1363
    elif dice_roll == 3:
        $ Laura.change_face("surprised2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1364
...
label Laura_flirt_ao:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1365
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1366
    elif dice_roll == 2:
        $ Laura.change_face("pleased2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1367
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1368
...
label Laura_flirt_ap:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1369
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1370
...
label Laura_flirt_aq:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1371
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1372
...
label Laura_flirt_ar:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1373
    call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1374
...
label Laura_flirt_b:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1375
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1376
    elif dice_roll == 3:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1377
    elif dice_roll == 4:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1378
...
label Laura_flirt_c:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1379 
    elif dice_roll == 2:
        $ Laura.change_face("confused1", blush = 1) 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1380
...
label Laura_flirt_d:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1381
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1382
    elif dice_roll == 3:
        $ Laura.change_face("smirk2", eyes = "left", blush = 1)

        "She doesn't say anything and just grabs your hand."

        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1383
...
label Laura_flirt_ea:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1384
...
label Laura_flirt_eb:
    if Player.location in public_locations and approval_check(Laura, threshold = [50, 100]):
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1385
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1386
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1387
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1390 
...
label Laura_flirt_f:
    if Player.location in public_locations and approval_check(Laura, threshold = [125, 150]):
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1393
    elif Player.location in public_locations:
        $ Laura.change_face("confused1") 
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1394
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1395
    else:
        $ Laura.change_face("confused2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1396
...
label Laura_flirt_g:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1397
...
label Laura_flirt_h:
    if approval_check(Laura, threshold = [150, 175]):
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1398
    else:
        ...
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1399
...
label Laura_flirt_i:
    if Player.location in public_locations and approval_check(Laura, threshold = [125, 150]):
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1400
    elif Player.location in public_locations:
        $ Laura.change_face("appalled1")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1401
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1405
...
label Laura_flirt_l:
    if Player.location in public_locations and approval_check(Laura, threshold = [175, 200]):
        ...
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1406

        $ Laura.change_face("sexy", blush = 1) 

        ch_Laura "I enjoyed that. . ." 

        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1407
    elif Player.location in public_locations:
        $ Laura.change_face("confused2")
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1408
    elif Laura.quirk:
        $ Laura.change_face("confused1")
        ...
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1409
        ...
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1410

        ch_Laura "Almost hard enough. . ."

        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1411
    else:
        $ Laura.change_face("confused1")
        ...
        call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1412
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1413
...
label Laura_flirt_oa:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1414
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1415
...
label Laura_flirt_ob:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1416
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1417
...
label Laura_flirt_qa:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1418
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1419 
    ...
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1420 
...
label Laura_flirt_qb:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1421
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1422
    ...
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1423
...
label Laura_flirt_qc:
    ...
    call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1424
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1425
    ...
    call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_1426 
...
label Laura_flirt_r:
    ...
    if dice_roll == 1:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1427
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1428
    elif dice_roll == 2:
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1429
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1430
    elif dice_roll == 3:
        $ Laura.change_face("worried2", blush = 1)
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1431
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1432
    elif dice_roll == 4:
        $ Laura.change_face("suspicious1", blush = 1)
        ...
        call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_1433
        call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_1434
