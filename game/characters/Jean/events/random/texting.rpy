...
label Jean_texting_study_response:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_71
...
label Jean_texting_training_response:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        ...
        if time_index > 2:
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1604
        else:
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_72
...
label Jean_texting_date_response:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        ...
        if time_index > 2:
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1599
        else:
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_73
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_74
...
label Jean_texting_summon_horny_response:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        ...
        call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_75
    elif Jean.text_history[-1][1] == temp[1]:
        call receive_text(Jean, "Good") from _call_receive_text_39
        call receive_text(Jean, "I can't wait <3") from _call_receive_text_40
        
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_76
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_77
