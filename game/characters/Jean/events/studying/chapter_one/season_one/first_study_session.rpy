...
label Jean_chapter_one_season_one_first_study_session:
    ...
    menu:
        ...
        "You know exactly where to look. . . amazing.":
            call change_Character_stat(Jean, "love", medium_stat) from _call_change_Character_stat_388
            call change_Character_stat(Jean, "trust", small_stat) from _call_change_Character_stat_389
        ...
        "Holy shit. . . are you a genius or something?":
            call change_Character_stat(Jean, "love", large_stat) from _call_change_Character_stat_390    
        ...
        "What the hell. . . is your entire life just spent studying and memorizing. . . ?":
            call change_Character_stat(Jean, "love", -medium_stat) from _call_change_Character_stat_391    
