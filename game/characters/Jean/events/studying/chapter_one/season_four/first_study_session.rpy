...
label Jean_chapter_one_season_four_first_study_session:
    ...
    menu:
        ...
        "You zoned out again. . . tell me what's bothering you so much. Are you really okay?":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_117 
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_118
        "[temp]? Is everything really okay? You're getting distracted again. . .":
            $ Jean.change_face("worried2")

            ch_Jean "No, [Jean.Player_petname], I am {i}really{/i} not okay." 
            
            call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_119
        "Really? What the hell's gotten into you? At this rate, studying with [Laura.name] would be more productive. . .":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_120 
            call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_121
    ...
    menu:
        ...
        "[Jean.name], you can't think about it that way.":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_122 
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_123
        "I. . . give a shit. And you can't think like that.":
            ...
            call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_124
        "Oh please, stop lying to yourself.":
            $ Jean.change_face("appalled1")

            ch_Jean "What the hell?" 
            
            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_125 
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_126
