...
label Jean_back_from_mission:
    ...
    menu:
        ...
        "That sounds great! I'm happy to help [Jean.name], and I've been eager to learn how to use my powers.":
            call change_Character_stat(Jean, "love", medium_stat) from _call_change_Character_stat_169
            call change_Character_stat(Jean, "trust", medium_stat) from _call_change_Character_stat_170
        ...
        "An excuse to spend more time with [Jean.name]? Count me in.":
            call change_Character_stat(Jean, "love", small_stat) from _call_change_Character_stat_171
            call change_Character_stat(Jean, "trust", -small_stat) from _call_change_Character_stat_172
    ...
    menu:
        ...
        "So. . . I'll be your 'little bro''?":
            ...
            $ Jean.blush = 0
        "Heh, I guess so.":
            call change_Character_stat(Jean, "love", small_stat) from _call_change_Character_stat_176
    ...
    menu:
        ...
        "Yes, please.":
            ...
            call change_Character_stat(Jean, "love", medium_stat) from _call_change_Character_stat_177
        ...
        "That would be great.":
            ...
            call change_Character_stat(Jean, "love", small_stat) from _call_change_Character_stat_179
    ...
    menu:
        ...
        "You don't have to go out of your way. . .":
            call change_Character_stat(Jean, "love", -small_stat) from _call_change_Character_stat_387
