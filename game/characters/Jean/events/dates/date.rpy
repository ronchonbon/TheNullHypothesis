...
label Jean_date:
    ...
    if "Companion_initiated" in Player.date_planned[Jean]:
...
label Jean_date_dinner:
    ...
    if Player_picked_food and chosen_meal[Jean] in ["penne alla vodka", "crab cakes", "jambalaya"]:
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat
        ...
        menu:
            ...
            "Give her a bite":
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1
        ...
        "Offer to pay":
            if "Player_initiated" in Player.date_planned[Jean]:
                ...
                if Player.cash >= restaurant_bill[Player] + restaurant_bill[Jean]:
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_2
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_3
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_4
        "Recommend splitting the check":
            if "Player_initiated" in Player.date_planned[Jean]:
                ...
                if Player.cash >= math.ceil((restaurant_bill[Player] + restaurant_bill[Jean])/2):
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_5
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_6
...
label Jean_date_dinner_sex_handjob:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_7
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_8
...
label Jean_date_dinner_sex_blowjob:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_9
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_10
...
label Jean_date_dinner_sex_sex:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_11
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_12
...
label Jean_date_dinner_sex_eat_pussy:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_13
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_14
        ...
        "Offer to pay":
            if "Player_initiated" in Player.date_planned[Jean]:
                ...
                if Player.cash >= 2*ticket_price:
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_15
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_16
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_17
        "Recommend splitting the ticket price":
            if "Player_initiated" in Player.date_planned[Jean]:
                ...
                if Player.cash >= ticket_price:
                    ...
                    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_18
...
label Jean_date_movie_ron_bic1:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_19
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_20
...
label Jean_date_movie_ron_bic2:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_21
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_22
...
label Jean_date_movie_hamburg_portfolio:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_23
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_24
...
label Jean_date_movie_beautiful_flower:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_25
...
label Jean_date_movie_fated:
    ...
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_26 
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_27
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_28
...
label Jean_date_movie_refilling_empty_glass:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_29
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_30
...
label Jean_date_movie_stale_air:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_31
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_32
...
label Jean_date_movie_devils_spring_break:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_33
...
label Jean_date_movie_unsanctioned_crusade:
    ...
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_34
...
label Jean_date_movie_sex_makeout:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_35
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_36
...
label Jean_date_movie_sex_handjob:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_37
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_38
...
label Jean_date_movie_sex_touch_pussy:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_39
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_40
...
label Jean_date_movie_sex_finger_pussy:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_41
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_42
...
label Jean_date_movie_sex_blowjob:
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_43
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_44
...
label Jean_date_mall_wander:
    ...
    if Player in second_event.keys() and Jean in Partners:
        menu:
            ...
            "Ask [Jean.name] if you can hold hands.":
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_45
                call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_46 
            ...
            "Just grab [Jean.name]'s hand.": 
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_47
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_48
