    ...
    while chatting:
        menu:
            ...
            "Do you think we could keep things the way they are? I really care about you a lot, but I'm not ready to be more than friends." if asked_single:
                call change_Character_stat(Jean, "love", -medium_stat) from _call_change_Character_stat_1610
                call change_Character_stat(Jean, "trust", medium_stat) from _call_change_Character_stat_1611
