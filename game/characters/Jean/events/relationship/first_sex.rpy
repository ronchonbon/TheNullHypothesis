...
label Jean_first_sex_part_one:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1101
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1102
    ...
    menu:
        ...
        "Look, I can tell this is important to you. . . but I really don't know what you're talking about. . .":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1103 
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1104
        ...
        "Wha. . . wait a minute. Are you talking about. . .?":
            call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1105
...
label Jean_first_sex_part_two:
    ...
    menu:
        ...
        "I really did. . . I'm glad we could share that together.":
            ...
            call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1106
        "That wasn't too bad. Just need more. . . practice.":
            $ Jean.change_face("confused1", blush = 1) 
            
            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1107
