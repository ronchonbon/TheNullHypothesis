...
label Jean_enjoying_being_girlfriend:
    ...
    menu:
        ...
        "Uhm. . . [Jean.petname], what did I do to deserve this?":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1094
    ...
    menu:
        ...
        "I won't say no to having my beautiful big sis' spoil me. . . (encourage_quirk)":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1095 
            call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1096
    ...
    menu:
        ...
        "Of course I am. I know we haven't been together all that long, but you're a wonderful girlfriend. . .":
            ...
            call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1097 
            call change_Girl_stat(Jean, "trust", 2) from _call_change_Girl_stat_1098
        "Are you kidding me? I couldn't ask for a better girlfriend. . .":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1099
        "Well. . . yeah, it's not too bad. . .":
            ...
            call change_Girl_stat(Jean, "love", -3) from _call_change_Girl_stat_1100
