...
label Jean_chapter_one_season_two_second_training_session:
    ...
    menu:
        ...
        "I don't mind at all. If anything, it'd be good to tell someone about the details.":
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_210 
            call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_211

            $ choice = "A"
        "I. . . I'll try. Not like I can ever forget how it felt. . .":
            $ Jean.change_face("worried2") 
            
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_212

            $ choice = "B"
        "I guess I can. . . really didn't want to relive those memories, but fine.":
            $ Jean.change_face("worried1", eyes = "left") 
            
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_213 
            call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_214
