...
label Jean_chapter_one_season_two_first_training_session:
    ...
    menu:
        ...
        "I am, really. I appreciate your concern.":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_198
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_199
        "Not really. . . but thanks for caring.":
            $ Jean.change_face("worried2")

            ch_Jean "Of course I care!" 
            
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_200
        "I'm not dead so, yeah. . . mostly just pissed that I was so useless.":
            $ Jean.change_face("angry1")

            ch_Jean "You weren't useless!" 
            
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_201
    ...
    menu:
        ...
        "[temp], I've just been stumbling through this, getting lucky. You're still far more impressive than I've ever been.":
            ...
            call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_202 
        "Okay, but it's not like I'll be catching up to you any time soon.":
            $ Jean.change_face("worried1")

            ch_Jean "I know, I know. . ." 
            
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_203
        "Oh please, you're probably the most powerful person I've ever met. So what if things aren't going fast enough for you.":
            ...
            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_204
    ...
    menu:
        ...
        "You shouldn't bottle your feelings up just for my sake. I'm here for you as well. . .":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_205 
            call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_206
        "I appreciate it. Might have to take you up on that. . . everything has been so stressful lately.":
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_207
        "Thanks, I guess. . . I'll be fine.":
            $ Jean.change_face("angry1", eyes = "right")

            ch_Jean "Whatever. . ." 
            
            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_208
    ...
    call change_Girl_stat(Jean, "trust", 20) from _call_change_Girl_stat_209
