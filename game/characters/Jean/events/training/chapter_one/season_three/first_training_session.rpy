...
label Jean_chapter_one_season_three_first_training_session:
    ...
    menu:
        ...
        "I'm not thrilled about it either. . . but if anything, I'm stronger for it now.":
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_184
            call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_185
        "How do you think I feel?! This time was much worse too. . .":
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_186
        "If I can get over it, so can you. Plus, it only made me stronger in the end.":
            ...
            call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_187 
            call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_188
    ...
    menu:
        ...
        "It has to do with who my friends are.":
            ...
            call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_189
