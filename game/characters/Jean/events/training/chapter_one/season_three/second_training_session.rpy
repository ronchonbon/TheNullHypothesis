...
label Jean_chapter_one_season_three_second_training_session:
    ...
    menu:
        ...
        "Not at all. I feel bad about all the stress you're going through.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_191
            call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_192
        "It made me a little sad to have you upset at me. . . But don't worry, I understand.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_193
        "A little bit to be honest. . . it was pretty uncalled for. But it's fine, I'd be frustrated too if I were in your shoes.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_194
            call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_195
