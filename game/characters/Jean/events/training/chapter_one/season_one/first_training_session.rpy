...
label Jean_chapter_one_season_one_first_training_session:
    ...
    while chatting:
        menu:
            ...
            "You are pretty damn smart." if not smart:
                call change_Girl_stat(Jean, "love", medium_stat) from _call_change_Girl_stat_392
                call change_Girl_stat(Jean, "trust", small_stat) from _call_change_Girl_stat_393
            ...
            "Eventually? I guess you'll be helpful. . ." if not smart:
                call change_Girl_stat(Jean, "love", -medium_stat) from _call_change_Girl_stat_423
            ...
            "Sure, I wouldn't mind the help." if smart and not control:
                call change_Girl_stat(Jean, "love", -small_stat) from _call_change_Girl_stat_424
    ...
    if Laura.History.check("trained_with_Player") >= 2:
        ...
        call change_Girl_stat(Jean, "love", small_stat) from _call_change_Girl_stat_425
    ...
    menu:
        ...
        "I'm glad you're not hurt.":
            call change_Girl_stat(Jean, "love", small_stat) from _call_change_Girl_stat_426
        ...
        "Good thing I was here, someone might've gotten hurt.":
            call change_Girl_stat(Jean, "trust", -small_stat) from _call_change_Girl_stat_683
...
label Jean_chapter_one_season_one_first_training_session_1A:
    ...
    menu:
        ...
        "I want to help however I can.":
            ...
            call change_Girl_stat(Jean, "love", medium_stat) from _call_change_Girl_stat_828
            call change_Girl_stat(Jean, "trust", small_stat) from _call_change_Girl_stat_829
        ...
        "I don't know if I can be of much help.":
            call change_Girl_stat(Jean, "love", small_stat) from _call_change_Girl_stat_830
            call change_Girl_stat(Jean, "trust", -small_stat) from _call_change_Girl_stat_842
...
label Jean_chapter_one_season_one_first_training_session_1B:
    ...
    menu:
        extend ""
        "Uh, I guess. . .":
            call change_Girl_stat(Jean, "love", -medium_stat) from _call_change_Girl_stat_843
            
            $ Jean.change_face("worried1")

            ch_Jean "You don't sound so happy about it. . ."
        "Thanks, [Jean.petname], I really appreciate it.":
            call change_Girl_stat(Jean, "love", medium_stat) from _call_change_Girl_stat_844
            call change_Girl_stat(Jean, "trust", small_stat) from _call_change_Girl_stat_845
