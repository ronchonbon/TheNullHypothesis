...
label Jean_chapter_one_season_four_first_training_session:
    ...
    menu:
        ...
        "[temp]. . . you only feel that way because you care about me so much.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_142
            call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_143
        "I'm more glad than anyone. . . but it can't stay like this.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_144
        "Trust me, it feels great finally being powerful. . . but even I know there's something missing.":
            ...
            call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_145
            call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_146
    ...
    menu:
        ...
        "If I can't control myself, I'll be just as bad as them. . . I need to focus, so I don't go overboard.":
            ...
            if Player.History.check("told_Jean_angry_at_protesters_during_mutant_hate"):
                ...
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_147 
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_148
            else:
                ...
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_149
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_150
        "It's scary. . . not being able to control myself. . . I might go too far. . .":
            ...
            if Player.History.check("told_Jean_was_scared_during_mutant_hate"):
                ...
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_151
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_152
            else:
                ...
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_153
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_154 
        "Maybe those people deserved worse than I gave them, but that should be my choice, not my power's.":
            ...
            if Player.History.check("told_Jean_angry_at_protesters_during_mutant_hate"):
                ...
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_155
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_156
            else:
                ch_Jean "What's gotten into you?" 
                ch_Jean "You can't let what happened affect you this much. . ." 
                
                call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_157
                call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_158
