label Jean_designer_purse_shopping_accept:
    ...
    call change_Girl_stat(Jean, "love", 50) from _call_change_Girl_stat_1299
    call change_Girl_stat(Jean, "trust", 25) from _call_change_Girl_stat_1300
...
label Jean_designer_purse_gift_accept:
    ...
    call change_Girl_stat(Jean, "love", 50) from _call_change_Girl_stat_1301
    call change_Girl_stat(Jean, "trust", 25) from _call_change_Girl_stat_1302
