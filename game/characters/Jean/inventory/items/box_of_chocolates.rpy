label Jean_box_of_chocolates_shopping_accept:
    ...
    call change_Girl_stat(Jean, "love", 25) from _call_change_Girl_stat_1291
    call change_Girl_stat(Jean, "trust", 10) from _call_change_Girl_stat_1292
...
label Jean_box_of_chocolates_gift_accept:
    ...
    call change_Girl_stat(Jean, "love", 25) from _call_change_Girl_stat_1293
    call change_Girl_stat(Jean, "trust", 10) from _call_change_Girl_stat_1294
