label Jean_plant_shopping_accept:
    ...
    if "plant1" in Jean.inventory.keys() or "plant2" in Jean.inventory.keys() or "plant3" in Jean.inventory.keys():
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1307
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1308
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1309
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1310
...
label Jean_plant_gift_accept:
    ...
    if "plant1" in Jean.inventory.keys() or "plant2" in Jean.inventory.keys() or "plant3" in Jean.inventory.keys():
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1311
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1312
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1313
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1314
