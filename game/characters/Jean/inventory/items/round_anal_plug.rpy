label Jean_round_anal_plug_shopping_accept:
...
label Jean_round_anal_plug_shopping_reject:
...
label Jean_round_anal_plug_gift_accept:
    $ Jean.change_face("worried2")
...
label Jean_round_anal_plug_gift_reject:
    $ Jean.change_face("appalled2")
...
label Jean_round_anal_plug_change_reject:
...
label Jean_round_anal_plug_change_reject_worn_out:
    $ Jean.change_face("worried2")
