label Jean_candle_shopping_accept:
    ...
    call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_1295
    call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_1296
...
label Jean_candle_gift_accept:
    ...
    call change_Girl_stat(Jean, "love", 0) from _call_change_Girl_stat_1297
    call change_Girl_stat(Jean, "trust", 0) from _call_change_Girl_stat_1298
