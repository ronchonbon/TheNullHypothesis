label Jean_wholesome_romance_novel_shopping_accept:
    if EventScheduler.Events["Jean_gifts"].completed:
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1325
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1326
...
label Jean_wholesome_romance_novel_gift_accept:
    if EventScheduler.Events["Jean_gifts"].completed:
        ...
        call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1327
        call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1328
