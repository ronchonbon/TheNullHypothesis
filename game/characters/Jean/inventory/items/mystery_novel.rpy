label Jean_mystery_novel_shopping_accept:
    if EventScheduler.Events["Jean_gifts"].completed:
        ...
        call change_Girl_stat(Jean, "love", 40) from _call_change_Girl_stat_1303
        call change_Girl_stat(Jean, "trust", 20) from _call_change_Girl_stat_1304
...
label Jean_mystery_novel_gift_accept:
    if EventScheduler.Events["Jean_gifts"].completed:
        ...
        call change_Girl_stat(Jean, "love", 40) from _call_change_Girl_stat_1305
        call change_Girl_stat(Jean, "trust", 20) from _call_change_Girl_stat_1306
