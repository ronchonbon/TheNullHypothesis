label Jean_steamy_romance_novel_shopping_accept:
    ...
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_1315
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1316
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1317 
...
label Jean_steamy_romance_novel_gift_accept:
    ...
    call change_Companion_stat(Jean, "desire", 0) from _call_change_Companion_stat_1318
    ...
    call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_1319
    call change_Companion_stat(Jean, "trust", 0) from _call_change_Companion_stat_1320 
