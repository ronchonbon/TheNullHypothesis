...
label Jean_text_how_are_you:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_255
...
label Jean_text_how_are_you_late_accept:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_256
...
label Jean_text_how_are_you_relationship:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_257
...
label Jean_text_how_are_you_love:
    ...
    if Jean.text_history[-1][1] == temp[0]:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_258
    elif Jean.text_history[-1][1] == temp[2]:
        call receive_text(Jean, "Don't have to be an ass") from _call_receive_text_117

        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_259
...
label Jean_text_how_are_you_horny:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_260
...
label Jean_text_how_are_you_nympho:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_261
...
label Jean_text_good_morning:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_262
...
label Jean_text_good_morning_relationship:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_263
...
label Jean_text_good_morning_love:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_264
    elif dice_roll == 2:
        ...
        if Jean.text_history[-1][1] == temp[0]:
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_265
        elif Jean.text_history[-1][1] == temp[2]:
            call receive_text(Jean, "Whatever, never mind") from _call_receive_text_144

            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_266
...
label Jean_text_good_morning_horny:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_267
...
label Jean_text_good_morning_nympho:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_268
...
label Jean_text_goodnight:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_269
...
label Jean_text_goodnight_relationship:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_270
...
label Jean_text_goodnight_love:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_271
    elif dice_roll == 2:
        ...
        if Jean.text_history[-1][1] == temp[0]:
            ...
            call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_272
        elif Jean.text_history[-1][1] == temp[2]:
            call receive_text(Jean, "Ugh") from _call_receive_text_167
            call receive_text(Jean, "Whatever") from _call_receive_text_168

            call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_273
...
label Jean_text_goodnight_horny:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_274
...
label Jean_text_goodnight_nympho:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_275
...
label Jean_text_ignored:
    ...
    call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_276
    ...
    if not Jean.History.check("went_on_date_with_Player"):
        ...
        if time_index == 2:
            ...
            if Player.location == "bg_hallway":
                ...
                if Jean.text_history[-1][1] == temp[0]:
                    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_277
        else:
            ...
            if Jean.text_history[-1][1] == temp[0]:
                call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_278
