...
label Jean_flirt_aa:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_223 
    elif dice_roll == 2:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_224 
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_225
...
label Jean_flirt_ab:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_226
    elif dice_roll == 2:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_227
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_228
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_229
...
label Jean_flirt_ac:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_230
    elif dice_roll == 2:
        $ Jean.change_face("pleased2", blush = 1)
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_231
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_232
    elif dice_roll == 4:
        $ Jean.change_face("pleased1", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_233
...
label Jean_flirt_ad:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_234
    elif dice_roll == 2:
        $ Jean.change_face("sly", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_235
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_236
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_237
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_238
    elif dice_roll == 4:
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_239
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_240
...
label Jean_flirt_ae:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1187
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1188
    elif dice_roll == 2:
        $ Jean.change_face("sly", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1189
        call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1190
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1191
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_1192
    elif dice_roll == 4:
        $ Jean.change_face("perplexed") 
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1193
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_1194
...
label Jean_flirt_af:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1195 
    elif dice_roll == 2:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1196
...
label Jean_flirt_ag:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1197
    elif dice_roll == 2:
        $ Jean.change_face("surprised2")
        ...
        call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1198
    elif dice_roll == 3:
        $ Jean.change_face("perplexed") 
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1199
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_1200
    elif dice_roll == 4:
        $ Jean.change_face("appalled2") 
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_1201
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_1202
...
label Jean_flirt_ah:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1203
    elif dice_roll == 2:
        $ Jean.change_face("surprised2")
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1204
...
label Jean_flirt_ai:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1205
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1206
    elif dice_roll == 2:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1207
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1208
    elif dice_roll == 3:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1209
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1210
    elif dice_roll == 4:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1211
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1212
...
label Jean_flirt_aj:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1213 
    elif dice_roll == 2:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1214 
    elif dice_roll == 3:
        $ Jean.change_face("surprised2")
        ...
        call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1215
...
label Jean_flirt_ak:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_241
    elif dice_roll == 2:
        $ Jean.change_face("pleased2", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_242
    elif dice_roll == 3:
        $ Jean.change_face("perplexed") 
        ...
        call change_Girl_stat(Jean, "love", -5) from _call_change_Girl_stat_243
        call change_Girl_stat(Jean, "trust", -5) from _call_change_Girl_stat_244
...
label Jean_flirt_al:
    ...
    call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1216 
...
label Jean_flirt_am:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1217
    elif dice_roll == 2:
        $ Jean.change_face("surprised2")
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1218
    elif dice_roll == 3:
        $ Jean.change_face("sly", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1219
...
label Jean_flirt_an:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1220
    elif dice_roll == 2:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1221
    elif dice_roll == 3:
        $ Jean.change_face("surprised2")
        ...
        call change_Girl_stat(Jean, "love", 7) from _call_change_Girl_stat_1222
...
label Jean_flirt_ao:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1223
        call change_Girl_stat(Jean, "trust", 3) from _call_change_Girl_stat_1224
    elif dice_roll == 2:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1225
        call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1226
...
label Jean_flirt_ap:
    ...
    call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1227
    call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1228
...
label Jean_flirt_aq:
    ...
    call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1229
    call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1230
...
label Jean_flirt_ar:
    ...
    call change_Girl_stat(Jean, "love", 10) from _call_change_Girl_stat_1231
    call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1232
...
label Jean_flirt_b:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1233
    elif dice_roll == 2:
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1234
    elif dice_roll == 3:
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1235
    elif dice_roll == 4:
        ...
        call change_Girl_stat(Jean, "love", 4) from _call_change_Girl_stat_1236
...
label Jean_flirt_c:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1237 
    elif dice_roll == 2:
        $ Jean.change_face("confused1", mouth = "smirk", blush = 1) 
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1238
...
label Jean_flirt_d:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1239
    elif dice_roll == 2:
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1240
    elif dice_roll == 3:
        ch_Jean "C'mere. . ."
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1241
...
label Jean_flirt_ea:
    ...
    call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1242
...
label Jean_flirt_eb:
    if Player.location in public_locations and approval_check(Jean, threshold = [100, 50]):
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1243
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1244
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1245
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1246 
        ...
        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1247 
        ...
        if Player.stamina and Jean.stamina:
            menu:
                extend ""
                "Make out with her":
                    call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1248
...
label Jean_flirt_f:
    if Player.location in public_locations and approval_check(Jean, threshold = [50, 25]):
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1249
    elif Player.location in public_locations:
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1250
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1251
    else:
        $ Jean.change_face("pleased2")
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1252
...
label Jean_flirt_g:
    ...
    call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1253
...
label Jean_flirt_h:
    if approval_check(Jean, threshold = [175, 150]):
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1254
    else:
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1255
...
label Jean_flirt_i:
    if Player.location in public_locations and approval_check(Jean, threshold = [125, 125]):
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1256
    elif Player.location in public_locations:
        $ Jean.change_face("perplexed")
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1257

        $ Jean.change_face("kiss2", blush = 2) 

        "She holds you tight against her, and starts running her hands across your body." 

        call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1258
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1261
...
label Jean_flirt_l:
    if Player.location in public_locations and approval_check(Jean, threshold = [350, 325]):
        ...
        call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1262
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1263
    elif Player.location in public_locations:
        $ Jean.change_face("perplexed")
        ...
        call change_Girl_stat(Jean, "love", -2) from _call_change_Girl_stat_1264
    elif Jean.quirk:
        $ Jean.change_face("perplexed")
        ...
        call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1265
        ...
        call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1266

        ch_Jean "I enjoyed that. . ."

        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1267
    else:
        ...
        call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1268
        ...
        call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1269
...
label Jean_flirt_oa:
    ...
    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1270
    call change_Girl_stat(Jean, "desire", 5) from _call_change_Girl_stat_1271
...
label Jean_flirt_ob:
    ...
    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1272
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1273
...
label Jean_flirt_qa:
    ...
    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1274
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1275 
    ...
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1276 
...
label Jean_flirt_qb:
    ...
    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1277
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1278
    ...
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1279
...
label Jean_flirt_qc:
    ...
    call change_Girl_stat(Jean, "love", 3) from _call_change_Girl_stat_1280
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1281
    ...
    call change_Girl_stat(Jean, "desire", 10) from _call_change_Girl_stat_1282
...
label Jean_flirt_r:
    ...
    if dice_roll == 1:
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1283
        call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1284
    elif dice_roll == 2:
        $ Jean.change_face("worried1", blush = 1)
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1285
        call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1286
    elif dice_roll == 3:
        $ Jean.change_face("happy", blush = 1)
        ...
        call change_Girl_stat(Jean, "love", 5) from _call_change_Girl_stat_1287
        call change_Girl_stat(Jean, "trust", 5) from _call_change_Girl_stat_1288
    elif dice_roll == 4:
        $ Jean.change_face("sly", blush = 1)
        ...
        call change_Girl_stat(Jean, "love", 2) from _call_change_Girl_stat_1289
        call change_Girl_stat(Jean, "trust", 2) from _call_change_Girl_stat_1290
