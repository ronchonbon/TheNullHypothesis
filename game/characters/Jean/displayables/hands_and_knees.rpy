...
layeredimage Jean_hands_and_knees:
    ...
    if Player.orgasming in ["cumshot", "cum_in_mouth"] and focused_Girl == Jean:
    ...
    if Player.orgasming in ["cum_in_mouth", "cum_down_throat"] and focused_Girl == Jean:
...
layeredimage Jean_hands_and_knees_torso:
    if Player.orgasming in ["cumshot", "cum_down_throat"] and focused_Girl == Jean:
        "Jean_hands_and_knees_left_arm_handjob_animation0"
    elif Player.orgasming == "cum_in_mouth" and focused_Girl == Jean:
...
layeredimage Jean_hands_and_knees_head:
    if Player.orgasming == "cum_in_mouth" and focused_Girl == Jean:
