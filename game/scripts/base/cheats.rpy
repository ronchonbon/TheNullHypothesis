    ...
    if parsed_code[0] == "give" and len(parsed_code) > 1:
        ...
        if parsed_code[1] in Cast and len(parsed_code) == 4:
            if parsed_code[2] in ["love", "trust", "desire"]:
                ...
                if Companion:
                    call change_Companion_stat(Companion, parsed_code[2], int(parsed_code[3])) from _call_change_Companion_stat_834
        ...
        while temp_Characters:
            call change_Companion_stat(temp_Characters[0], "love", 1000) from _call_change_Companion_stat_835
            call change_Companion_stat(temp_Characters[0], "trust", 1000) from _call_change_Companion_stat_836
