...
screen seizure_warning():
    ...
    frame anchor (0.5, 0.5) pos (0.5, 0.35):
        background None

        padding (25, 25, 25, 25)

        text "This game contains optional {color=#ffb100}flashing sequences{/color} and {color=#ffb100}effects{/color}.":
            size 40

            color "#ffffff"

    frame anchor (0.5, 0.5) pos (0.5, 0.65):
        style_prefix "confirm"
        ...
        vbox:
            ...
            text _("Disable flashing effects?"):
                size 40
            ...
            hbox:
                ...
                textbutton _("Yes"):
                    ...
                    action [
                        SetVariable("flashing_lights", False),
                        Return()]
                ...
                textbutton _("No"):
                    ...
                    action [
                        SetVariable("flashing_lights", True),
                        Return()]
