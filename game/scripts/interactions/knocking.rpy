label Player_knocks(host):
    ...
    $ Present = get_Present(location = host.home)
    ...
    if time_index == 3 and not approval_check(sorted_Characters[0], threshold = "talk_late"):
        if sorted_Characters[0].History.check("said_too_late_to_talk", tracker = "recent") >= 2:
            call change_Girl_stat(sorted_Characters[0], "love", -5) from _call_change_Girl_stat_982
            call change_Girl_stat(sorted_Characters[0], "trust", -5) from _call_change_Girl_stat_983
            ...
            call change_Girl_stat(sorted_Characters[0], "love", -2) from _call_change_Girl_stat_984
        ...
        if status:
            ...
            if sorted_Characters[0].History.check("rejected_knock_on_door", tracker = "recent") > 2:
                call change_Girl_stat(sorted_Characters[0], "love", -5) from _call_change_Girl_stat_985
                call change_Girl_stat(sorted_Characters[0], "trust", -5) from _call_change_Girl_stat_986
                ...
                call change_Girl_stat(sorted_Characters[0], "love", -5) from _call_change_Girl_stat_987
                call change_Girl_stat(sorted_Characters[0], "trust", -5) from _call_change_Girl_stat_988
                ...
                call change_Girl_stat(sorted_Characters[0], "love", -2) from _call_change_Girl_stat_989
