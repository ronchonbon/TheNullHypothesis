    ...
    if Character.status["miffed"] or Character.status["mad"]:
        ...
        if Toy.string in ["heart_anal_plug", "round_anal_plug"]:
            if Character.History.check(f"said_no_to_{Toy.string}", tracker = "recent") >= 2:
                call change_Character_stat(Character, "love", -small_stat) from _call_change_Character_stat_1023
                call change_Character_stat(Character, "trust", -small_stat) from _call_change_Character_stat_1024
                ...
                call change_Character_stat(Character, "love", -tiny_stat) from _call_change_Character_stat_1025
            ...
            if Character.History.check(f"said_no_to_{Toy.string}", tracker = "recent") >= 2:
                call change_Character_stat(Character, "love", -small_stat) from _call_change_Character_stat_1026
                call change_Character_stat(Character, "trust", -small_stat) from _call_change_Character_stat_1027

                call expression f"{Character.tag}_rejected_{Toy.string}_twice" from _call_expression_343
            elif Character.History.check(f"said_no_to_{Toy.string}", tracker = "recent") == 1:
                call change_Character_stat(Character, "love", -tiny_stat) from _call_change_Character_stat_1028
