label start_following(Character):
    ...
    if status == "mad":
        ...
        if Character.History.check("said_no_to_following", tracker = "recent") >= 2:
            call change_Girl_stat(Character, "love", -5) from _call_change_Girl_stat_970
            call change_Girl_stat(Character, "trust", -5) from _call_change_Girl_stat_971
            ...
            call change_Girl_stat(Character, "love", -2) from _call_change_Girl_stat_972
        ...
        if approval_check(Character, threshold = "love"):
            ...
            if Character.History.check("said_no_to_following", tracker = "recent") >= 2:
                call change_Girl_stat(Character, "love", -5) from _call_change_Girl_stat_973
                call change_Girl_stat(Character, "trust", -5) from _call_change_Girl_stat_974

                call expression f"{Character.tag}_follow_reject_asked_twice" from _call_expression_226
            elif Character.History.check("said_no_to_following", tracker = "recent") == 1:                    
                call change_Girl_stat(Character, "love", -2) from _call_change_Girl_stat_975
