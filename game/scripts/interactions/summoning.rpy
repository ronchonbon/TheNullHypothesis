label summon(Character):
    ...
    if time_index == 3 and not approval_check(Character, threshold = "talk_late"):
        if Character.History.check("said_too_late_to_text", tracker = "recent") >= 2:
            call change_Girl_stat(Character, "love", -5) from _call_change_Girl_stat_1004
            call change_Girl_stat(Character, "trust", -5) from _call_change_Girl_stat_1005
            ...
            call change_Girl_stat(Character, "love", -2) from _call_change_Girl_stat_1006
        ...
        #     call expression f"{Character.tag}_summon_{status}" from _call_expression_307
            ...
            if approval_check(Character, threshold = "love"):
                ...
                if Character.History.check("said_no_to_summon", tracker = "recent") >= 2:
                    call change_Girl_stat(Character, "love", -5) from _call_change_Girl_stat_1007
                    call change_Girl_stat(Character, "trust", -5) from _call_change_Girl_stat_1008
                    ...
                    call change_Girl_stat(Character, "love", -2) from _call_change_Girl_stat_1009
    ...
    if Character in all_Companions:
        if approval_check(Character, threshold = "follow") and Player.location != Character.home:
            ...
            if Character.History.check("said_no_to_dismiss", tracker = "recent") >= 2:
                call change_Girl_stat(Character, "love", -5) from _call_change_Girl_stat_1010
                call change_Girl_stat(Character, "trust", -5) from _call_change_Girl_stat_1011
                ...
                call change_Girl_stat(Character, "love", -2) from _call_change_Girl_stat_1012
