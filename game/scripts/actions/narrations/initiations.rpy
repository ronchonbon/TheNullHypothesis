label makeout_initiations(Action):
    ...
    while temp_Characters:
        ...
        elif temp_Characters[0] in [Laura, Jean]:
...
label finger_pussy_initiations(Action):
    ...
    while temp_Characters:
        if temp_Characters[0].desire >= eval(f"{temp_Characters[0].tag}_Action_desire_thresholds['{Action.Action_type}']"):
            "Your fingers glide across [temp_Characters[0].name]'s pussy, already wet and inviting, and you start gently pushing them inside."
            "She gasps as you enter her, and you feel her tense around your fingers."
        else:
            "She seems a little uncomfortable as you start pushing your fingers past her soft folds."
...
label eat_pussy_initiations(Action):
    ...
    while temp_Characters:
        "You bring your lips up to [temp_Characters[0].name]'s pussy, giving it a gentle kiss, before slowly teasing it with your tongue."
...
label grab_ass_over_clothes_initiations(Action):
    ...
    while temp_Characters:
        if temp_Characters[0] in [Rogue]:
            "You wrap your hand around [temp_Characters[0].name]'s voluptuous ass. It spills through your fingers, soft and inviting even through her bottoms."
        elif temp_Characters[0] in [Laura, Jean]:
            "You wrap your hand around [temp_Characters[0].name]'s tight ass. It comfortably fits in your hand, supple yet firm even through her bottoms."
...
label grab_ass_initiations(Action):
    ...
    while temp_Characters:
        if temp_Characters[0] in [Rogue]:
            "You wrap your hand around [temp_Characters[0].name]'s voluptuous ass. It spills through your fingers, soft and inviting, her skin warm to the touch."
        elif temp_Characters[0] in [Laura, Jean]:
            "You wrap your hand around [temp_Characters[0].name]'s tight ass. It comfortably fits in your hand, supple yet firm, her skin soft and warm."
...
label finger_ass_initiations(Action):
    ...
    while temp_Characters:
        ...
        if temp_Characters[0].History.check("finger_ass") >= 5:
            "As you press your finger up against her hole, [temp_Characters[0].name] leans back into you, inviting it inside. Your finger slides in easily, eliciting a soft moan."
        elif temp_Characters[0].History.check("finger_ass") >= 2:
            "[temp_Characters[0].name]'s still not used to putting anything up there, and you encounter some resistance as your press your finger up against her hole. Eventually it slides in, and she tightens around you."
        else:
            "You press your finger up against [temp_Characters[0].name]'s hole, slowly pressing it inside against the resistance. She involuntarily tightens around your finger, but manages to relax as it slides in all the way."
...
label eat_ass_initiations(Action):
    ...
    while temp_Characters:
        "Spreading [temp_Characters[0].name]'s cheeks with your hands, you slowly drag your tongue along her crack, circling around, licking anywhere but her hole."
    ...
    while temp_Characters:
        if temp_Characters[0].History.check("handjob") >= 2:
            if temp_Characters[0] in [Rogue]:
                ...
                "[temp_Characters[0].name] reaches out excitedly, wrapping her fingers around you and relishing the sensation of you in her hand."
            elif temp_Characters[0] in [Laura]:
                $ temp_Characters[0].change_face("sly", mouth = "lipbite", blush = 2) 
                
                "[temp_Characters[0].name] doesn't waste any time and grabs you as if she's been waiting for this all day, her gaze locked onto yours with a glint of desire."
            elif temp_Characters[0] in [Jean]:
                $ temp_Characters[0].change_face("sexy", eyes = "down", blush = 2) 
                
                "[temp_Characters[0].name] teases you a bit with some light touches, enjoying how you involuntarily twitch, before finally wrapping her fingers around you."
        else:
            if temp_Characters[0] in [Rogue]:
                $ temp_Characters[0].change_face("worried1", eyes = "down", mouth = "lipbite", blush = 2) 
                
                "[temp_Characters[0].name] tentatively reaches out, slowly wrapping her fingers around you. She relishes the feeling of you between her fingers, before starting to move." 
                ...
                "[temp_Characters[0].name] reaches out, grabbing you as if she expects it to run off. Her grip is tight, and she spends a moment marveling at the sensation before starting to move." 
                ...
                "[temp_Characters[0].name] reaches out, dragging a finger across your length, feeling the novel texture. She gently wraps her fingers around you, a bit too gently, before starting to move." 
        ...
        if Action.mode == 3:
            ...
            if temp_Characters[0].History.check("blowjob") >= 2:
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] reaches out excitedly, pulling you up to her lips, hungry for the feeling of you in her mouth."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("sly", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] pulls you up to her mouth, not wasting a single second, as her lips press into your cock."
                elif temp_Characters[0] in [Jean]:
                    $ temp_Characters[0].change_face("sexy", eyes = "down", blush = 2) 
                    
                    "[temp_Characters[0].name] teases you a bit with some gentle kissing, enjoying how you involuntarily twitch, before finally pressing her lips up against your cock."
            else:
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] slowly brings her lips down to you, lightly brushing them against your cock. After the first touch, it seems like she can't help herself and goes in for more." 
                    ...
                    "Despite her compunctions, [temp_Characters[0].name] presses her lips up against you, inhaling your scent all the while." 
                    ...
                    "[temp_Characters[0].name] slowly pulls her lips down to you, touching them lightly to your cock causing you to involuntarily twitch. She still seems apprehensive, but seeing you twitch like that. . ." 
        ...
        if temp_Characters[0].History.check("deepthroat") >= 2:
            if temp_Characters[0].throat_training == 1:
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] looks down at you, a bit apprehensive."
                    ...
                    "[temp_Characters[0].name] has a determined look on her face, as she gets ready to try and take you all in." 
                    "Her lips wrap around you, and it doesn't seem like she's learned much as she goes too deep too fast and gags."
                elif temp_Characters[0] in [Jean]:
                    $ temp_Characters[0].change_face("worried1", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name]'s eyes are locked on your cock, sizing you up." 
                    "After a bit of hesitation, she finally wraps her lips around you." 
            elif temp_Characters[0].throat_training == 2:
                if temp_Characters[0] in [Rogue]:
                    $ temp_Characters[0].change_face("sexy", blush = 2) 
                    
                    "[temp_Characters[0].name] looks into your eyes, a gleam of excitement in her own."
                    "She wraps her lips around you, taking you in with more confidence than before."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("angry1", eyes = "down", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] stares down at your cock for a while, like a predator sizing up its prey."
                    "Her lips wrap around you, more cautiously this time, and she takes things slow."
                elif temp_Characters[0] in [Jean]:
                    $ temp_Characters[0].change_face("confused1", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] looks down at your cock with less apprehension than before."
                ...
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] looks down at your cock, ready to take you as deep as she can handle."
                    "She wraps her lips around you with zero hesitation."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("sexy", blush = 2) 
                    
                    "[temp_Characters[0].name] stares into your eyes, a gleam of excitement in them." 
                    ...
                    $ renpy.say(temp_Characters[0].voice, "I'm starting to get pretty good at this.")
                ...
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] looks down at your cock with lustful eyes."
                    "She starts taking you in like she's been waiting for this all day."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("sly", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] stares into your eyes, you get a sense of self satisfaction in them." 
                    ...
                    $ renpy.say(temp_Characters[0].voice, "I think enjoy this as much as you do.")
            ...
            if temp_Characters[0] in [Rogue]:
                ...
                "[temp_Characters[0].name] stares down at your cock, a bit daunted by the task in front of her." 
...
label grind_pussy_initiations(Action):
    ...
    while temp_Characters:
        ...
        if dice_roll == 1:
            "You lay your cock across [temp_Characters[0].name]'s crotch, immediately feeling the heat radiating off of it."
        elif dice_roll == 2:
            "[temp_Characters[0].name] leans her hips into you, seeking to feel your cock press against her."
...
label grind_ass_initiations(Action):
    ...
    while temp_Characters:
        ...
        if dice_roll == 1:
            "You lay your cock in between [temp_Characters[0].name]'s cheeks and press up against her hole."
        elif dice_roll == 2:
            "[temp_Characters[0].name] leans her hips into you, seeking to feel your cock press against her."
...
label sex_initiations(Action):
    ...
    while temp_Characters:
        if Action.mode == 2:
            ...
            if temp_Characters[0].History.check("sex") >= 3:
                if temp_Characters[0] in [Rogue]:
                    $ temp_Characters[0].change_face("sexy", eyes = "down", blush = 2) 
                    
                    "[temp_Characters[0].name] looks down excitedly, wiggling her hips at you, ready to take it in." 
                    "You gently press yourself up against her hole, teasing it, feeling how wet she already is."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("sly", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] has that look in her eye, one that says she wants you to fuck her already." 
                    ...
                    "[temp_Characters[0].name] teases you a bit, pulling her hips away." 
                ...
                if temp_Characters[0] in [Rogue]:
                    ...
                    $ renpy.say(temp_Characters[0].voice, "But I need to get used to it.")
...
label anal_initiations(Action):
    ...
    while temp_Characters:
        if Action.mode < 2 or temp_Characters[0].anal_training >= 2:
            if temp_Characters[0].anal_training == 1:
                if temp_Characters[0] in [Rogue]:
                    ...
                    "You slowly press your cock into her, the tight hole providing a lot of resistance as [temp_Characters[0].name] growls from the pain."
                elif temp_Characters[0] in [Jean]:
                    $ temp_Characters[0].change_face("worried1", mouth = "lipbite", blush = 2) 
                    ...
                    "Slowly, you manage to get the tip in, [temp_Characters[0].name] whimpering from the pain." 
            elif temp_Characters[0].anal_training == 2:
                if temp_Characters[0] in [Rogue]:
                    $ temp_Characters[0].change_face("worried1", eyes = "down", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] looks down at you, still a bit of apprehension in her eyes." 
                    "You slowly press the tip into her, and she takes it without showing too much discomfort."
                elif temp_Characters[0] in [Laura]:
                    $ temp_Characters[0].change_face("angry1", eyes = "down", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name]'s starting to get used to your size, but still looks down at your cock with trepidation." 
                    "You gently push your cock inside her and it goes in without too much difficulty."
                elif temp_Characters[0] in [Jean]:
                    $ temp_Characters[0].change_face("worried1", eyes = "down", mouth = "lipbite", blush = 2) 
                    
                    "[temp_Characters[0].name] looks down at your cock, worry written across her face." 
                ...
                if temp_Characters[0] in [Rogue]:
                    ...
                    "[temp_Characters[0].name] looks down at your cock, ready to take you as deep as you can give her." 
                    ...
                    "[temp_Characters[0].name] stares down at your cock, an air of excitement about her, as taking all of you isn't a problem anymore." 
            ...
            if temp_Characters[0] in [Rogue]:
                ...
                $ renpy.say(temp_Characters[0].voice, "I still don't understand how all of you. . .")
                
                $ temp_Characters[0].change_face("worried1", eyes = "down", mouth = "lipbite", blush = 2) 
                
                $ renpy.say(temp_Characters[0].voice, ". . . could fit back there.")
            ...
            $ temp_Characters[0].desire -= 10 if temp_Characters[0].desire >= 10 else 0
