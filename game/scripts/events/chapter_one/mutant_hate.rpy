...
label ch1_mutant_hate:
    ...
    menu:
        ...
        "Fine. . . (encourage_quirk)":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_920 
            call change_Companion_stat(Laura, "desire", 0) from _call_change_Companion_stat_921
    ...
    menu:
        ...
        "I did what I had to do, just wish they didn't force my hand like that. . . (determined)":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_922
        ...
        "I was scared shitless. . . would probably be dead without your training. . . (reluctant)":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_923
        ...
        "You're right, they tried to fucking kill me afterall. (bitter)":
            ...
            call change_Companion_stat(Laura, "love", 0) from _call_change_Companion_stat_924
            call change_Companion_stat(Laura, "trust", 0) from _call_change_Companion_stat_925
    ...
    if Jean.History.check("quirk_encouraged") >= Jean.History.check("quirk_discouraged"):
        ...
        menu:
            ...
            "Lean into her for comfort":
                ...
                call change_Companion_stat(Jean, "love", 0) from _call_change_Companion_stat_926
    ...
    menu:
        ...
        "I did what I had to do. . . but I don't feel good about it. (determined)":
            ...
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_927 
            call change_Companion_stat(Rogue, "trust", 0) from _call_change_Companion_stat_928
        ...
        "To be honest, it was scarier than when those Sentinels attacked. . . (reluctant)":
            ...
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_929
        ...
        "They had it coming. Imagine if I didn't have my power. . . (bitter)":
            ...
            call change_Companion_stat(Rogue, "love", 0) from _call_change_Companion_stat_930
