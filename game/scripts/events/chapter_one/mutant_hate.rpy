...
init python:
    ...
    def ch1_season_three_main_Quest():
        ...
        objectives = {
            ...
            "Train with [Rogue.name]": ["Rogue.History.check('trained_with_Player', tracker = 'season')", 2],
            ...
            "Gain 750 Trust across all characters": ["Rogue.trust + Laura.trust + Jean.trust", 750]}
...
init python:
    ...
    def ch1_season_three_complete():
        ...
        conditions = [
            "QuestPool.Quests['Chapter I: Spring'].completed"]
...
label ch1_mutant_hate:
    ...
    if Player.visible_mutation:
        ch_Kurt "Put yours up too, mein brüder."
    ...
    menu:
        ...
        "What the fuck is wrong with these people? (bitter)":
            ...
            ch_Kurt "I am upset too, mein brüder." 
