    ...
    if not Rogue.History.check("Player_faked_injury"):
        ...
        menu:
            "Apologize properly":
                ...
                call change_Character_stat(Rogue, "love", medium_stat) from _call_change_Character_stat_890
            ...
            "Accept her forgiveness":
                call change_Character_stat(Rogue, "trust", -tiny_stat) from _call_change_Character_stat_640
...
label day_three_meet_Jean:
    ...
    $ Jean.change_arms(left_arm = "hip", right_arm = "extended")
    ...
    menu:
        ...
        "I'm okay, and it is a lot, but I'll adapt. I have to.":
            call change_Character_stat(Jean, "trust", medium_stat) from _call_change_Character_stat_1609
